...
export const RESPONSES: Record<string, string[]> = {
  ...
  // ── PEUR ──
  PEUR: [
    "Hey… c'est normal d'avoir peur 😔 tu veux que je reste avec toi ?",
    "Le noir peut faire peur… mais je suis là avec toi 💛 tu veux qu'on imagine une lumière magique ?",
    "Tu sais quoi ? Même les grands ont peur parfois 😊 qu'est-ce qui te fait le plus peur ?",
    "Je comprends… ça peut faire peur 😟 on respire doucement ensemble ?",
    "Tu n'es pas seul, je suis là avec toi 💛 tu veux que je te raconte une petite histoire ?",
    "C'est courageux de me le dire 💪 tu veux qu'on transforme la peur en jeu ?",
    "La peur, ça arrive à tout le monde… tu veux m'expliquer ce que tu ressens ?",
    "Je reste avec toi, ok ? 😊 on peut imaginer un endroit magique ensemble",
    "Respire doucement… tout va bien, je suis là 💛 tu veux qu'on joue pour penser à autre chose ?",
    "Tu veux que je t'aide à te sentir plus rassuré ? Je suis là 💛",
  ],
  // ── TRISTESSE ──
  TRISTESSE: [
    "Oh… tu te sens triste ? 😔 je suis là pour toi, tu veux m'expliquer ?",
    "Je comprends… ça fait mal parfois 💛 tu veux en parler ?",
    "Tu peux tout me dire, je t'écoute vraiment 👂",
    "C'est normal d'être triste parfois… tu veux que je reste avec toi ?",
    "On peut rester tranquille ensemble si tu veux 💛",
    "Ta tristesse compte… qu'est-ce qui s'est passé ?",
    "Tu n'es pas seul, je suis là avec toi 💛",
    "Tu veux que je te change les idées un peu ? 😊",
    "Parfois parler aide… tu veux essayer ?",
    "Je suis là pour toi, même dans les moments difficiles 💛",
  ],
  // ── COLERE ──
  COLERE: [
    "Je vois que tu es en colère 😠 tu veux me dire pourquoi ?",
    "C'est normal d'être en colère parfois… on respire ensemble ?",
    "On peut se calmer doucement… je suis avec toi 💛",
    "Ta colère veut dire quelque chose… tu veux m'expliquer ?",
    "Respire… doucement… je reste là avec toi 💛",
    "Tu veux une idée pour te calmer ? 😊",
    "On peut faire une pause ensemble",
    "Tu n'es pas obligé de rester en colère 💛 je suis là",
    "Je t'écoute, dis-moi ce qui se passe",
    "On peut trouver une solution ensemble 💪",
  ],
  // ── JOIE ──
  JOIE: [
    "Waaah trop bien !! 😄 raconte-moi !",
    "J'adore quand tu es content !! qu'est-ce qui se passe ? 😄",
    "Ça a l'air génial 😄 tu veux partager ?",
    "Trop cool !! on fête ça ? 🎉",
    "Tu rayonnes là 😄 j'adore !",
    "C'est quoi qui t'a rendu heureux ? 😊",
    "Encore encore !! 😄 raconte !",
    "Ça me rend content aussi 😊",
    "Tu veux qu'on fasse un jeu pour fêter ça ? 🎉",
    "C'est une super journée pour toi 😄 tu veux qu'on continue ?",
  ],
  // ── CONFIANCE ──
  CONFIANCE: [
    "Hey… t'es pas nul du tout 💛 tu apprends, et c'est déjà super !",
    "C'est normal d'avoir des doutes… tu veux qu'on essaye ensemble ?",
    "Tu es capable, vraiment 💪 je crois en toi !",
    "Chaque effort compte, même les petits 😊",
    "Je crois en toi 😊 on y va doucement ?",
    "Tu veux que je t'aide ? On fait ça ensemble 💛",
    "On peut y aller doucement, pas à pas",
    "Tu progresses déjà, même si tu ne le vois pas 💪",
    "Tu es plus fort que tu crois 💪 je le sais !",
    "On le fait ensemble ? Je suis avec toi 💛",
  ],
  // ── JALOUSIE ──
  JALOUSIE: [
    "Ça arrive de se sentir comme ça… tu veux m'expliquer ? 💛",
    "La jalousie, c'est normal parfois 💛 je t'écoute",
    "Tu veux me dire ce que tu ressens exactement ?",
    "On peut en parler ensemble 😊",
    "Tu es important toi aussi 💛 ne l'oublie pas !",
    "Chacun a ses choses à lui 😊 et toi tu es spécial !",
    "Tu veux qu'on trouve ce qui te rend unique ? 💪",
    "Je suis là pour t'écouter 💛",
    "On peut transformer ça en quelque chose de positif 💪",
    "Tu comptes beaucoup 💛 tu veux qu'on parle ?",
  ],
  // ── ENNUI ──
  ENNUI: [
    "On joue ? 😄 j'ai plein d'idées !",
    "Je te propose un défi ! Tu es prêt ? 💪",
    "Tu veux une histoire ou un jeu ? À toi de choisir !",
    "Devine à quoi je pense ! 🤔 un indice : c'est un animal…",
    "On invente un monde ensemble ? 🌍✨",
    "Attends, j'ai une super idée pour toi ! 🎉",
    "Et si on faisait un quiz ? Je parie que tu vas tout trouver ! 🧠",
    "Tu préfères un défi rapide ou une histoire ? 😊",
    "On fait un jeu de devinettes ? Je commence ! 🎮",
    "Bobby a une mission secrète pour toi… tu acceptes ? 🕵️",
  ],
  IDENTITY: [
