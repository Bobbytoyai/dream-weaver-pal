...
export const MOUTHS: Record<string, MouthPreset> = {
  ...
  open:          { openness: 0.3,  width: 0.5,  curve: 0,     round: 0.1,  jawDrop: 0.2 },
  round_o:       { openness: 0.35, width: 0.4,  curve: 0,     round: 0.45, jawDrop: 0.25 },
  sad:           { openness: 0.02, width: 0.4,  curve: -0.2,  round: 0,    jawDrop: 0 },
  pout:          { openness: 0.05, width: 0.35, curve: -0.15, round: 0.1,  jawDrop: 0.03 },
  ...
  surprised:     { openness: 0.35, width: 0.5,  curve: 0,     round: 0.4,  jawDrop: 0.3 },
  tired:         { openness: 0,    width: 0.38, curve: 0.02,  round: 0,    jawDrop: 0 },
  worried:       { openness: 0.05, width: 0.38, curve: -0.1,  round: 0.05, jawDrop: 0.02 },
  ...
  embarrassed:   { openness: 0.04, width: 0.45, curve: 0.08,  round: 0.05, jawDrop: 0.01 },
  wow:           { openness: 0.4,  width: 0.45, curve: 0,     round: 0.5,  jawDrop: 0.35 },
  hmm:           { openness: 0.03, width: 0.35, curve: -0.03, round: 0.08, jawDrop: 0.01 },
  oh:            { openness: 0.25, width: 0.42, curve: 0,     round: 0.35, jawDrop: 0.15 },
  ...
  small_open:    { openness: 0.12, width: 0.42, curve: 0,     round: 0.1,  jawDrop: 0.06 },
...
export const ANIMATIONS: Record<string, AnimationPreset> = {
  ...
  look_shift: {
    headTiltX: 0, headTiltY: 0, headTiltZ: 0.05,
    glowIntensity: 0.4, cheekGlow: 0.12,
    oscillation: [
      { property: "headTiltZ", amplitude: 0.03, frequency: 1.5 },
    ],
  },
  calm_wave: {
    headTiltX: 0, headTiltY: 0, headTiltZ: 0,
  ...
  micro_shake: {
    ...
    oscillation: [
      { property: "headTiltX", amplitude: 0.015, frequency: 8 },
      { property: "headTiltZ", amplitude: 0.02, frequency: 6 },
    ],
  },
  micro_nod: {
