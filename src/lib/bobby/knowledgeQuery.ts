...
const SEMANTIC_FIELDS: Record<string, string[]> = {
  ...
  sang:       ["rouge", "blessure", "bobo", "corps", "coeur", "veine", "peur"],
  ...
  nuit:       ["dormir", "etoile", "lune", "noir", "reve", "cauchemar", "peur"],
  reveil:     ["matin", "dormir", "sonnerie", "lever", "heure", "ecole"],
  ...
  note:       ["ecole", "resultat", "bonne", "mauvaise", "controle", "bulletin"],
  ...
  pirate:     ["bateau", "tresor", "mer", "ile", "drapeau", "aventure", "carte"],
