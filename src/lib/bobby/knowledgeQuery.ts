...
const SEMANTIC_FIELDS: Record<string, string[]> = {
  ...
  recycler:       ["dechet", "poubelle", "tri", "plastique", "verre", "papier", "ecologie", "planete"],
  pollution:      ["air", "eau", "plastique", "dechet", "usine", "voiture", "ecologie", "danger", "sante"],
  ...
  deforestation:  ["foret", "arbre", "couper", "animaux", "biodiversite", "amazonie", "ecologie", "danger"],
  compost:        ["dechet", "terre", "jardin", "organique", "ver", "recycler", "ecologie", "engrais"],
  "energie renouvelable":["soleil", "vent", "eau", "eolienne", "panneau solaire", "ecologie", "propre", "futur"],
  eolienne:       ["vent", "electricite", "energie", "tourner", "pale", "ecologie", "renouvelable"],
  "panneau solaire":["soleil", "electricite", "energie", "toit", "photovoltaique", "ecologie", "renouvelable"],
  plastique:      ["pollution", "dechet", "ocean", "recycler", "bouteille", "sac", "ecologie", "danger"],
  poubelle:       ["dechet", "recycler", "tri", "jeter", "propre", "ecologie", "couleur"],
  "espece menacee":["animal", "disparaitre", "proteger", "panda", "baleine", "tigre", "ecologie", "biodiversite"],
  "parc national":["nature", "proteger", "animal", "foret", "reserve", "ranger", "ecologie", "visite"],
  ...
  tigre:          ["asie", "rayure", "felin", "chasse", "jungle", "puissant", "animal", "espece menacee"],
  gorille:        ["afrique", "singe", "fort", "intelligent", "foret", "animal", "famille"],
  singe:          ["arbre", "grimper", "malin", "banane", "jungle", "animal", "gorille", "chimpanze"],
  panda:          ["bambou", "chine", "noir", "blanc", "mignon", "animal", "espece menacee", "wwf"],
  kangourou:      ["australie", "saut", "poche", "bebe", "marsupial", "animal", "boxe"],
  koala:          ["australie", "eucalyptus", "dormir", "mignon", "arbre", "animal", "marsupial"],
  loup:           ["foret", "hurler", "meute", "lune", "contes", "animal", "predateur", "chien"],
  renard:         ["ruse", "foret", "roux", "queue", "animal", "nuit", "petit prince"],
  ours:           ["foret", "fort", "hibernation", "griffe", "miel", "animal", "polaire", "brun"],
  ...
  hibou:          ["nuit", "rapace", "hou", "arbre", "yeux", "sage", "animal", "chouette"],
  aigle:          ["rapace", "voler", "haut", "montagne", "vue", "puissant", "animal", "royal"],
  ...
  tortue:         ["carapace", "lent", "mer", "terre", "vieux", "animal", "oeuf", "plage"],
  ...
  araignee:       ["toile", "tisser", "patte", "peur", "insecte", "attraper", "mouche"],
  ver:            ["terre", "compost", "sol", "long", "pluie", "jardin", "insecte"],
  libellule:      ["eau", "aile", "voler", "rapide", "insecte", "mare", "ete"],
  cigale:         ["chanter", "ete", "chaleur", "insecte", "fable", "fourmi"],
  escargot:       ["coquille", "lent", "bave", "pluie", "jardin", "antenne", "animal"],
  ...
  nid:            ["oiseau", "construire", "oeuf", "bebe", "branche", "arbre", "animal"],
