...
const FAQS = [
  ...
  { q: "Quels sont les abonnements disponibles ?", a: "La version gratuite offre les fonctions de base. Bobby+ (4.99€/mois) débloque la conversation illimitée, toutes les voix, le Bobby Store complet, le dashboard parent et la mémoire Cloud. Bobby Pro (9.99€/mois) ajoute le multi-enfants et l'analyse avancée." },
