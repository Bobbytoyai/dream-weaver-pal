...
const FAQS = [
  ...
  { q: "Les conversations sont-elles enregistrées ?", a: "Les conversations sont transcrites et stockées de manière sécurisée pour permettre l'analyse dans le dashboard parent. Les données sont chiffrées et hébergées en Europe, conformément au RGPD." },
  ...
  { q: "Quels sont les abonnements disponibles ?", a: "Bobby est 100% gratuit avec 500 Mo de stockage Cloud inclus ! Toutes les fonctionnalités (conversation, jeux, histoires, dashboard parent, Bobby Store) sont incluses sans frais. Deux abonnements optionnels permettent d'augmenter le stockage Cloud : Cloud 5 (4,90€/mois - 5 Go) et Cloud 20 (9,90€/mois - 20 Go) pour une mémoire et une base de connaissances enrichies." },
  { q: "Bobby peut-il dire des choses inappropriées ?", a: "Non. Chaque message est filtré par notre système de sécurité avant tout traitement. Les contenus inappropriés sont bloqués, les sujets sensibles redirigent vers un adulte, et les parents peuvent bloquer des thématiques spécifiques." },
  ...
  { q: "Bobby est-il disponible en magasin ?", a: "Bobby est actuellement en précommande à 89€ (au lieu de 129€). Le lancement en magasin est prévu pour Q3 2026. L'application web est disponible gratuitement dès maintenant." },
