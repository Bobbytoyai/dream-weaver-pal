...
const FAQS = [
  ...
  { q: "Quels sont les abonnements disponibles ?", a: "Bobby est 100% gratuit ! Toutes les fonctionnalités (conversation, jeux, histoires, dashboard parent, Bobby Store) sont incluses sans frais. Un abonnement optionnel Bobby Cloud+ permet d'augmenter la capacité de mémoire et la base de connaissances de Bobby pour une expérience encore plus personnalisée." },
