  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "#FDF6EC", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', 'Helvetica Neue', sans-serif" }}>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-8">
        ...
        <RetroSection>
          <h2 className="text-lg font-black text-black mb-3">Éditeur du site</h2>
        ...
        <RetroSection>
          <h2 className="text-lg font-black text-black mb-3">Hébergement</h2>
          <div className="space-y-1 text-xs font-black text-black">
        ...
        <RetroSection>
          <h2 className="text-lg font-black text-black mb-3">Propriété intellectuelle</h2>
        ...
        <RetroSection>
          <h2 className="text-lg font-black text-black mb-3">Conditions Générales de Vente</h2>
        ...
        <RetroSection>
          <h2 className="text-lg font-black text-black mb-3">Politique de Confidentialité</h2>
          <div className="space-y-2 text-xs font-black text-black leading-relaxed">
        ...
        <RetroSection>
          <h2 className="text-lg font-black text-black mb-3">RGPD — Protection des mineurs</h2>
          <div className="space-y-2 text-xs font-black text-black leading-relaxed">
