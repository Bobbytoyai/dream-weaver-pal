  ...
  },
  {
    ...
    content: (
      <div className="space-y-2 text-xs font-black text-black leading-relaxed">
        ...
        <p><strong>Abonnement Cloud :</strong> Bobby Cloud 5 (4,90€/mois, 5 Go) ou Cloud 20 (9,90€/mois, 20 Go) pour augmenter la mémoire et la base de connaissances de Bobby. Résiliable à tout moment. Bobby reste 100% gratuit (500 Mo inclus) sans abonnement.</p>
      </div>
    ),
  },
  {
